...
class TennisEvents{
    ...
    enum EventWinner: String, Codable {
        case firstPlayer = "First Player"
        case secondPlayer = "Second Player"
    }

    enum LeagueName: String, Codable {
        case atpDubai = "ATP Dubai"
    }

    enum LeagueRound: String, Codable {
        case atpDubai18Finals = "ATP Dubai - 1/8-finals"
        case atpDubaiFinal = "ATP Dubai - Final"
        case atpDubaiQuarterFinals = "ATP Dubai - Quarter-finals"
        case atpDubaiSemiFinals = "ATP Dubai - Semi-finals"
    }

    // MARK: - Score
    struct Score: Codable {
        var scoreFirst, scoreSecond, scoreSet: String?
